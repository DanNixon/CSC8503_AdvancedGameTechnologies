...
public:
  ...
  virtual void OnInitializeScene() override
  {
    ...
    // Create Hanging Cube (Attached by corner)
    {
      ...
      PhysicsEngine::Instance()->AddConstraint(new DistanceConstraint(
          ...
          cube->Physics()->GetPosition() +
              Vector3(-0.5f, -0.5f, -0.5f))); // Attachment Position on Object B
  ...
  virtual void OnUpdateScene(float dt) override
  {
    ...
    bool drawConstraints = PhysicsEngine::Instance()->GetDebugDrawFlags() &
    ...
    NCLDebug::AddStatusEntry(Vector4(1.0f, 0.9f, 0.8f, 1.0f),
                             "     Draw Constraints : %s (Press C to toggle)",
                             drawConstraints ? "Enabled" : "Disabled");
    ...
    PhysicsEngine::Instance()->SetDebugDrawFlags(
        drawConstraints ? DEBUGDRAW_FLAGS_CONSTRAINT : NULL);
  }
};