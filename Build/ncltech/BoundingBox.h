...
struct BoundingBox
{
  ...
  // Initialize minPoints to max possible value and vice versa to force the
  // first value incorporated to always be used for both min and max points.
  BoundingBox()
  ...
  //  If no points have been set yet, both minPoints and maxPoints will equal
  //  the point provided.
  ...
  // Transform the given AABB and returns a new AABB that encapsulates the new
