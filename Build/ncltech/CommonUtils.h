...
static Object *BuildCuboidObject(const std::string &name, const Vector3 &pos, const Vector3 &scale, bool physics_enabled = false,
                          float inverse_mass = 0.0f, 
                          bool collidable = true,    
                          bool dragable = true, const Vector4 &color = Vector4(1.0f, 1.0f, 1.0f, 1.0f));

static Object * BuildSoftBodyDemo(size_t xNodeCount, size_t yNodeCount, float xNodeSpacing = 2.0f, float yNodeSpacing = 2.0f);
};