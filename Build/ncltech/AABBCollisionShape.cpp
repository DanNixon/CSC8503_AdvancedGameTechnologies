...
Hull AABBCollisionShape::m_CubeHull = Hull();
...
Matrix3 AABBCollisionShape::BuildInverseInertia(float invMass) const
{
  Matrix3 inertia;
...
void AABBCollisionShape::GetEdges(const PhysicsObject *currentObject, std::vector<CollisionEdge> *out_edges) const
{
  if (out_edges)
  {
...
void AABBCollisionShape::DebugDraw(const PhysicsObject *currentObject) const
{
...
void AABBCollisionShape::ConstructCubeHull()
{
  // Vertices
