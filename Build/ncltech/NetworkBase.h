...
public:
  ...
  // computer - default: use any available port number and disable incoming
  // connections
  // - max_peers defines the maximum number of connected peers the host can
  // support
  ...
  // - Example usage: BeginConnect(127,0,0,1, 1234) to connect to localhost on
  // port 1234
  ...
  // callback function in the form of an ENetEvent.
  //   Possible Event.type's include:
  //			ENET_EVENT_TYPE_CONNECT, returned when a peer is connected and has
  // responded via 'ConnectPeer' or an external peer is attempting to connect to
  // us and awaiting our confirmation
