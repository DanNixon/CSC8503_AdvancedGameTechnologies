...
SpringConstraint::SpringConstraint(PhysicsObject * obj1, PhysicsObject * obj2, const Vector3 & globalOnA, const Vector3 & globalOnB, float springConstant, float dampingFactor)
  : m_pObj1(obj1)
  , m_pObj2(obj2)
